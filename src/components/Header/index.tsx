...
export default function Header() {
   ...
   return (
      <>
         <header
            {...(isScrolled && { className: 'z-50 sticky inset-x-0 top-0 animate-fade-in-down' })}>
                     ...
                     <div className="z-30 flex w-full justify-between px-6 md:w-max md:px-0">
                        ...
                        <div className="flex max-h-10 items-center md:hidden">
                           <label
                              ...
                              <div
                                 id="line"
                                 className="m-auto h-0.5 w-6 rounded bg-sky-900 transition duration-300 dark:bg-gray-300"
                              />
                              <div
                                 id="line2"
                                 className="m-auto mt-2 h-0.5 w-6 rounded bg-sky-900 transition duration-300 dark:bg-gray-300"
                              />
                           </label>
                        </div>
                     </div>
